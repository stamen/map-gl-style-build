...
var $gXNCa$fastglob = require("fast-glob");
var $gXNCa$mapglstyleformat = require("map-gl-style-format");
...
Object.defineProperty(module.exports, "buildStyles", {
    enumerable: true,
    get: function get() {
        return $7ea1aa841ec97fa5$exports.buildStyles;
    }
});
 ...
 */ var $787eebfbd67e2373$var$buildStyle = function buildStyle(name, absoluteStylePath, layerDir) {
    ...
    styleJson.layers = template.layers.map(function(layerName) {
        ...
        var _buildLayer = $787eebfbd67e2373$var$buildLayer(context, layerName, layerPath), layer = _buildLayer.layer;
...
var $7ea1aa841ec97fa5$exports = {};
"use strict";

function $7ea1aa841ec97fa5$var$_typeof(obj1) {
    "@babel/helpers - typeof";
    return $7ea1aa841ec97fa5$var$_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) {
        return typeof obj;
    } : function(obj) {
        return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
    }, $7ea1aa841ec97fa5$var$_typeof(obj1);
}
Object.defineProperty($7ea1aa841ec97fa5$exports, "__esModule", {
    value: true
});
$7ea1aa841ec97fa5$exports.buildStyles = void 0;
function $7ea1aa841ec97fa5$var$_regeneratorRuntime() {
    "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ 
    $7ea1aa841ec97fa5$var$_regeneratorRuntime = function _regeneratorRuntime() {
        return exports;
    };
    ...
    function AsyncIterator(generator, PromiseImpl) {
        function invoke(method, arg, resolve, reject) {
            ...
            if ("throw" !== record.type) {
                ...
                return value1 && "object" == $7ea1aa841ec97fa5$var$_typeof(value1) && hasOwn.call(value1, "__await") ? PromiseImpl.resolve(value1.__await).then(function(value) {
...
function $7ea1aa841ec97fa5$var$_toConsumableArray(arr) {
    return $7ea1aa841ec97fa5$var$_arrayWithoutHoles(arr) || $7ea1aa841ec97fa5$var$_iterableToArray(arr) || $7ea1aa841ec97fa5$var$_unsupportedIterableToArray(arr) || $7ea1aa841ec97fa5$var$_nonIterableSpread();
}
function $7ea1aa841ec97fa5$var$_nonIterableSpread() {
    throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}
function $7ea1aa841ec97fa5$var$_iterableToArray(iter) {
    if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter);
}
function $7ea1aa841ec97fa5$var$_arrayWithoutHoles(arr) {
    if (Array.isArray(arr)) return $7ea1aa841ec97fa5$var$_arrayLikeToArray(arr);
}
function $7ea1aa841ec97fa5$var$_createForOfIteratorHelper(o, allowArrayLike) {
    var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"];
    if (!it) {
        if (Array.isArray(o) || (it = $7ea1aa841ec97fa5$var$_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {
            if (it) o = it;
            var i = 0;
            var F = function F() {};
            return {
...
function $7ea1aa841ec97fa5$var$_unsupportedIterableToArray(o, minLen) {
    if (!o) return;
    if (typeof o === "string") return $7ea1aa841ec97fa5$var$_arrayLikeToArray(o, minLen);
    var n = Object.prototype.toString.call(o).slice(8, -1);
    if (n === "Object" && o.constructor) n = o.constructor.name;
    if (n === "Map" || n === "Set") return Array.from(o);
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return $7ea1aa841ec97fa5$var$_arrayLikeToArray(o, minLen);
}
function $7ea1aa841ec97fa5$var$_arrayLikeToArray(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
    for(var i = 0, arr2 = new Array(len); i < len; i++)arr2[i] = arr[i];
    return arr2;
}
function $7ea1aa841ec97fa5$var$asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
...
function $7ea1aa841ec97fa5$var$_asyncToGenerator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
            function _next(value) {
                $7ea1aa841ec97fa5$var$asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
            }
            function _throw(err) {
                $7ea1aa841ec97fa5$var$asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
            }
            _next(undefined);
        });
    };
...
var $7ea1aa841ec97fa5$var$format = $gXNCa$mapglstyleformat.format;

var $7ea1aa841ec97fa5$var$buildStyle = $787eebfbd67e2373$exports.buildStyle;
var $7ea1aa841ec97fa5$var$buildStyles = /*#__PURE__*/ function() {
    var _ref = $7ea1aa841ec97fa5$var$_asyncToGenerator(/*#__PURE__*/ $7ea1aa841ec97fa5$var$_regeneratorRuntime().mark(function _callee(styleDir, layerDir, outputDir) {
        var options, includeExcludePaths, stylePaths, _iterator, _step, _loop1, _args2 = arguments;
        return $7ea1aa841ec97fa5$var$_regeneratorRuntime().wrap(function _callee$(_context2) {
            while(true)switch(_context2.prev = _context2.next){
                case 0:
                    options = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : {};
                    includeExcludePaths = options.includeExcludePaths;
                    _context2.next = 4;
                    return $gXNCa$fastglob([
                        $gXNCa$path.resolve("".concat(styleDir, "/**/*.js"))
                    ]);
                case 4:
                    stylePaths = _context2.sent;
                    _iterator = $7ea1aa841ec97fa5$var$_createForOfIteratorHelper(includeExcludePaths);
                    _context2.prev = 6;
                    _loop1 = /*#__PURE__*/ $7ea1aa841ec97fa5$var$_regeneratorRuntime().mark(function _loop() {
                        var includeExcludePath, flag, pathPattern, excludePaths, includePaths;
                        return $7ea1aa841ec97fa5$var$_regeneratorRuntime().wrap(function _loop$(_context) {
                            while(true)switch(_context.prev = _context.next){
                                ...
                                case 5:
                                    _context.next = 7;
                                    return $gXNCa$fastglob([
                                        $gXNCa$path.resolve(pathPattern)
                                    ]);
                                case 7:
                                ...
                                case 12:
                                    ...
                                    stylePaths = $7ea1aa841ec97fa5$var$_toConsumableArray(new Set(stylePaths.concat(includePaths)));
                                    return _context.abrupt("break", 15);
                                case 15:
                                case "end":
                ...
                case 21:
                    stylePaths.forEach(function(absoluteStylePath) {
                        var relativePath = $gXNCa$path.relative(styleDir, absoluteStylePath);
                        var _path$parse = $gXNCa$path.parse(relativePath), dir = _path$parse.dir, name = _path$parse.name;
                        var styleOutputDir = $gXNCa$path.resolve(outputDir, dir, name);
                        if (!$gXNCa$fs.existsSync(styleOutputDir)) $gXNCa$fs.mkdirSync(styleOutputDir, {
                            recursive: true
                        });
                        try {
                            // Passing in the relativePath as the style name so users can easily find issues
                            var _buildStyle = $7ea1aa841ec97fa5$var$buildStyle(relativePath, absoluteStylePath, layerDir, options), builtStyle = _buildStyle.styleJson;
                            builtStyle = $7ea1aa841ec97fa5$var$format(builtStyle);
                            $gXNCa$fs.writeFileSync($gXNCa$path.resolve(styleOutputDir, "style.json"), builtStyle);
                        } catch (e) {
...
$7ea1aa841ec97fa5$exports.buildStyles = $7ea1aa841ec97fa5$var$buildStyles;
